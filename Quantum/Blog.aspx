...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
		    ...
		    <div class="col s12 m12">
				    ...
				    <div class="parallax grey darken-4"><img class="responsive-img" src="Co-founders Netwrok_files/blog1.jpg"></div>
					    <div class="container" style="margin-top: .2em">
						    <div class="row">
							    <div class="show-on-medium-and-up hide-on-med-and-down col S12 M12 l12 " style="font-size:4em; margin-top:150px">
							        <p style="background:rgba(0,0,0,.6);" class="white-text text-darken-4 center-align">Publish, Media & News Blog</p>
							    </div>
                                <div class="hide-on-med-and-up col S12 M12 l12 " style="font-size:4em; margin-top:20px">
							        <p style="background:rgba(0,0,0,.6);" class="white-text text-darken-4 center-align">Publish, Media & News Blog</p>
							    </div>
						    </div>
					    </div>
    ...
    <asp:Panel runat="server" ID="pnlCreatePost" Visible="false">
        ...
        <div style="margin-top: 10px;"><asp:Button CssClass="btn btn-primary" runat="server" Text="Create New Post" ID="btn_CreateNewPost" OnClick="btn_CreateNewPost_Click" Width="200" /></div>
