<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="User_Search.aspx.cs" Inherits="Quantum.User_Search" enableEventValidation="false" %>
    ...
    <div class="row container nav-wrapper">
        <div class=" col s12 m2 l2" style="max-width:290px;width:290px;margin-left:5px">
            <section style="line-height: 12px; margin-top: 50px; margin-left: 40px; margin-right: 20px;"><!--start section 1-->
                ...
                <label style="font-size:17px; color:black">Skills :</label>
                <br />
                <select runat="server" id="cblSkills" multiple></select>
                <br /><br />           
                
                <label style="font-size:17px; color:black" for="rblStartUpExperience">Min. Investment (USD) :</label>
                <br />
                <label style="font-size:17px; color:black" for="rblIndustry">Industry :</label>
                <br>
        ...
        <div class="col S12 m10 l10">  
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                                ...
                                <ItemTemplate>  
                                    <div class="col s12 m6 l4" style="margin-top: 20px;">
                                        <div class="card hoverable">
                                            <a href='User.aspx?id=<%#DataBinder.Eval(Container.DataItem, "userid")%>'>
                                                <div class="card-content" style="max-height:340px; height:340px"> 
                                                <div class="card-image">
                                                    <img style="max-height:70px;height:70px;width:70px;max-width:70px;border-radius:100%" class="responsive-img" src='<%#File.uploadedFilesDirectory + "\\" + Data.DefaultValueOnEmptyString(DataBinder.Eval(Container.DataItem, "image").ToString(), "user_no_image.jpg")%>' alt="Card image cap">  
                                                </div>
                                                <br>
                                                <span class="card-title black-text"><%#Data.maxStringDisplay(DataBinder.Eval(Container.DataItem, "name"), 30)%></span>
                                                <div class="col m10 l10 s12"  style="padding-left: 10px;padding-right: 0px; padding-top: 10px; margin-right:0px;">
                                                    <table >
                                                        ...
                                                        <tr>
                                                        <th>Skill</th><td>:&nbsp;<%#Data.maxStringDisplay(Data.DefaultValueOnEmptyString(DataBinder.Eval(Container.DataItem, "skills").ToString(), "n/a"), 40)%></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                            ...
                            <asp:Repeater runat="server" ID="dgUsersAdmin">
                                <HeaderTemplate>
                                    <table>
                                </HeaderTemplate>
                                <ItemTemplate>    
                                    <tr>
                                        <td><img style="border-radius: 50%; width:30px;height:30px;" src="<%#File.uploadedFilesDirectory + "\\" + Data.DefaultValueOnEmptyString(DataBinder.Eval(Container.DataItem, "image").ToString(), "user_no_image.jpg")%>" alt="Card image cap"> <%#Data.maxStringDisplay(DataBinder.Eval(Container.DataItem, "name"), 30)%></td>
                                        <td><%#Data.maxStringDisplay(DataBinder.Eval(Container.DataItem, "createdDate"), 30)%></td>
                                        <td><%#DataBinder.Eval(Container.DataItem, "country")%></td> 
                                        <td><%#DataBinder.Eval(Container.DataItem, "industry")%></td>  
                                        <td><a href="User.aspx?id=<%#DataBinder.Eval(Container.DataItem, "userid")%>" class="waves-effect waves-light btn text-white">View</a></a></td>
                                        <td><a href="User_Edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "userid")%>" class="waves-effect waves-light btn text-white">Edit</a></a></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                                    </table>
