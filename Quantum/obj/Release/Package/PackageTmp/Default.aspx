...
<section><!--start section 1-->
	<div class="parallax-container" style="height:550px; font-family:calibri; background:rgba('0,0,0,.10')">
      <div class="parallax"><img class="responsive-img" src="Co-founders Netwrok_files/road.jpg"></div>
      <div class="container white-text text-darken-5" style="margin-top: 140px">
	  <span class=" hide-on-med-and-down ">
	  <div class="card hoverable" style="background:rgba(0,0,0,.6); width: 600px; margin-left: 250px; padding-top: 30px; padding-bottom: 40px; ">
        ...
        <h1 class=" center">Co-Founders Network</h1>
                    ...
                    <ContentTemplate>        
                            <asp:Panel CssClass="center" ID="Panel1" runat="server" DefaultButton="btnSignup" style="margin-top:30px">
								<asp:button CssClass="btn-large waves-effect waves-light hoverable" style="margin-top: 10px;font-size: 20px;font-family:calibri;" runat="server" ID="Button1" Text="Start a free trial" OnClick="btnSignup_Click" />
                            </asp:Panel>
	...
	<section><!--start section 2-->
			<div class="row center" style="font-family:calibri; margin-top: 70px; margin-bottom: 70px">
                <div class="container">
                    <div class="col s12">
